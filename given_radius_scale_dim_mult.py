# Command line: python, scale_dimension_multiply.py, desired radius, object tri file, and int num of object
...
if len(sys.argv) != 4:
    print "Error: pass in script name, desired radius, object tri file, num of shapes"
    ...
    """ calculates needed scale_index """
    scale_index = (2*radius)/width
    print "Scale index is: %s" %scale_index
    ...
    if tri_file == "../data/objects/cube.tri":
        ...
        l = (-1.0 * scale_index) - 0.11
    elif tri_file == "../data/objects/sphere.tri":
        j = 0
